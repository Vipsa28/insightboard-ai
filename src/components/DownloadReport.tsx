...
export default function DownloadReport() {
  const handleDownload = async () => {
    try {
      ...
      if (!chart) {
        alert("⚠️ No chart found to include in the report!");
        return;
      }
      ...
      try {
        ...
        console.warn("⚠️ html2canvas failed — using direct canvas fallback:", err);
      ...
      pdf.text("📊 InsightBoard.AI Report", 15, 15);
      pdf.setFontSize(12);
      ...
      pdf.setFontSize(14);
      pdf.text("💬 AI Insight Summary:", 15, yPos);
      pdf.setFontSize(12);
      ...
      pdf.setFontSize(10);
      pdf.text(
        `Generated by InsightBoard.AI • ${new Date().toLocaleString()}`,
        15,
        290
      );
